...
@Builder
@ExcelFileName(filename = "lang.comment.content.title.list")
public class ContentCommentDto implements ExcelDto {
    ...
    @ExcelColumnName(headerName = "lang.comment.title")
    private String contentTitle; // 작품 제목
    ...
    @ExcelColumnName(headerName = "lang.comment.comment_cnt")
